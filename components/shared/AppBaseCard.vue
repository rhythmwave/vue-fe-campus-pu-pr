...
<template>
  ...
  <div class="d-flex mainbox">
    ...
    <div class="right-part">
      ...
      <v-btn block variant="text" class="d-lg-none d-md-flex d-sm-flex" @click="sDrawer = !sDrawer">
  ...
  <v-navigation-drawer v-if="!lgAndUp" v-model="sDrawer" temporary width="320" top>
