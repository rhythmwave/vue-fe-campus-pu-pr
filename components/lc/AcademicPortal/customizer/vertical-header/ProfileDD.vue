    ...
    <v-sheet rounded="md" width="360" elevation="10">
        ...
        <div class="d-flex align-center mt-4 pb-6">
          ...
          <div class="ml-3">
            ...
            <span class="text-subtitle-1 font-weight-regular textSecondary">{{
              user.app_type == "root" ? "Superadmin" :
              user.app_type == "admin" ? user.admin_role_name :
                user.app_type == "student" ? "Mahasiswa" : "Dosen" }}</span>
      ...
      <div class="px-8 py-3">
        <div class="bg-lightprimary rounded-md pa-5 overflow-hidden position-relative">
          ...
          <img src="/images/backgrounds/unlimited-bg.png" alt="bg-img" class="right-pos-img" />
        </div>
      </div>
      <div class="pt-4 pb-6 px-8 text-center">
        <v-btn color="primary" variant="outlined" block to="/login">Logout</v-btn>
      </div>
    </v-sheet>
  </v-menu>
</template>
