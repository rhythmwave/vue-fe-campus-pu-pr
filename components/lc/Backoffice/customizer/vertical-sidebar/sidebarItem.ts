...
var sidebarItem = ():menu[] =>{
  if(permissions.name == 'root'){
    return [
        ...
        {
            title: "Log Aktivitas Backoffice",
            icon: Clock2Icon,
            to: "/root-backoffice/backoffice-activity-histories",
        },
        {
            title: "Log Aktivitas Portal",
  ...
  if(permissions.name == 'admin'){
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: "Daftar Pejabat Pengesah Dokumen",
            to: "/backoffice/official/official-list",
          },
          // {
          //   title: "Pejabat Pengesah",
          //   to: "/backoffice/official/certifying-officer",
          // },
          {
            title: "Pejabat Pengesah Dokumen",
      ...
      },
      {
        ...
        children: [
          {
            title: "Pengelolaan Aktivitas Mahasiswa",
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: "Profil Lulusan Per Yudisium",
