    ...
    <v-app-bar elevation="10" :priority="priority" height="70">
        <div :class="customizer.boxed ? 'maxWidth v-toolbar__content' : 'v-toolbar__content px-6'">
            ...
            <v-sheet v-if="showSearch" class="search-sheet v-col-12">
                <!-- <LcBackofficeVerticalHeaderSearchbar :closesearch="searchbox" /> -->
            </v-sheet>
            ...
            <v-sheet class="d-none d-lg-block">
                <!-- <LcBackofficeVerticalHeaderSearchbar /> -->
            </v-sheet>
            ...
            <!-- ------------------------------------------------>
            <div class="hidden-md-and-down">
                <LcBackofficeVerticalHeaderNavigations />
            </div>
            ...
            <!-- translate -->
            <!-- ---------------------------------------------- -->
            <LcBackofficeVerticalHeaderLanguageDD />
            ...
            <LcBackofficeVerticalHeaderNotificationDD />
            ...
            <div class="ml-3 mr-sm-0 mr-3">
                <LcBackofficeVerticalHeaderProfileDD />
            </div>
        </div>
    </v-app-bar>
    <v-navigation-drawer v-model="appsdrawer" location="right" temporary>
        <LcBackofficeVerticalHeaderRightMobileSidebar />
    </v-navigation-drawer>
</template>
