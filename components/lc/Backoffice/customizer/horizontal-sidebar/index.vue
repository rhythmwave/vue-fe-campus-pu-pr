            ...
            <div :class="customizer.boxed ? 'maxWidth' : 'px-6'">
                <ul class="gap-1 horizontal-navbar px-0">
                    ...
                    <li v-for="(item, i) in sidebarMenu" :key="i" class="navItem">
                        <!---If Has Child -->
                        <LcBackofficeHorizontalSidebarNavCollapse :item="item" :level="0" v-if="item.children" />
                        <!---Single Item-->
                        <LcBackofficeHorizontalSidebarNavItem :item="item" v-else />
                        <!---End Single Item-->
                    </li>
                </ul>
            </div>    
