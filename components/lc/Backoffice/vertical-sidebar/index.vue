...
onMounted(() => {
    ...
    if (userData.app_type != "root") {
        ...
        sidebarMenu.value = allMenu.value;
    }
})
const customizer = useCustomizerStore();
const sidebarMenu = shallowRef(<menu[]>[]);
const allMenu = shallowRef(sidebarItems());
</script>
        ...
        <perfect-scrollbar class="scrollnavbar">
            <v-list class="pa-6" density="compact">
                ...
                <template v-for="(item, i) in sidebarMenu">
                    ...
                    <!---If Has Child -->
                    <LcBackofficeVerticalSidebarNavCollapse class="leftPadding" :item="item" :level="0"
