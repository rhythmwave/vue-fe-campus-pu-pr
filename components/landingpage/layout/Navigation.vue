...
<template>
    ...
    <v-btn variant="text" color="primary" class="custom-hover-primary nav-links" href="https://demos.adminmart.com/premium/nuxtjs/modernize-nuxtjs/docs/" target="_blank">Documentation</v-btn>
    <v-btn class="custom-hover-primary bg-primary ml-2 text-white" flat href="#" target="_blank"
        ><span class="text-white">Buy Now</span></v-btn
    >
</template>
