...
import { CreateExaminerRoleRequest } from '~~/types/api/thesis/CreateExaminerRole';
import { createExaminerRole } from '~~/composables/api/admin-thesis/createExaminerRole';
...
const create = ref(<CreateExaminerRoleRequest>{
    name: '',
    remarks: '',
    sort: ''
})
...
async function save(){
    try {
        const { response: createRoleResponse, error } = await createExaminerRole(create.value)
                ...
                <v-col cols="12" sm="12">
                    <v-form ref="form" lazy-validation>
                        <v-row>
                            ...
                            <v-col cols="12" sm="12" class="float-left">
                                <v-text-field v-model="create.remarks" variant="outlined" hide-details label="Catatan" />
                            </v-col>
                            <v-col cols="12" sm="12" class="float-left">
