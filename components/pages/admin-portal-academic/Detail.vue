...
if(props.data.authentication_id != ''){
    getData()
}
</script>
<template>
    <v-card>
        ...
        <v-table class="month-table">
            ...
            <tbody>
                <PagesAdminPortalAcademicDetailItem title="Nim" :value="data.nim_number" />
                <PagesAdminPortalAcademicDetailItem title="Nama" :value="data.name" />
            </tbody>
            <thead>
                <tr>
            ...
            <tbody v-if="props.data.authentication_id != ''">
                <PagesAdminPortalAcademicDetailItem title="Username" :value="detail?.username" />
                <PagesAdminPortalAcademicDetailItem title="Profil" :value="detail?.student_name" />
                <PagesAdminPortalAcademicDetailItem title="Hak Akses" :value="detail?.authentication_type == 'student' ? 'Mahasiswa' : 'Dosen'" />
                <PagesAdminPortalAcademicDetailItem title="Studi Program" :value="data.study_program_name" />
            </tbody>
            <tbody v-else>
                <tr>
