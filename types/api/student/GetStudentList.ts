...
export interface GetStudentListRequest {
    ...
    regencyId: string
    status: string[]
    getAcademicGuidance: any
    hasAuthentication: any
    studyPlanSemesterId: string
    studyPlanIsApproved: any
    studyPlanIsSubmitted: any
    hasStudyPlan: any
    statusSemesterId: string
    isRegistered: any
    hasPaid: any
    isGraduateEligible: any
    isThesisEligible: any
    yudiciumSessionId: any
}


export interface GetStudentListRoot {
    meta: MetaModel
    pagination: PaginationModel
    data: GetStudentListData[]
}
...
export interface GetStudentListData {
    ...
    academic_guidance_semester_id: string
    academic_guidance_semester_name: string
    current_semester_package: number
    study_plan_id: string,
    study_plan_maximum_credit: number
    study_plan_total_optional_credit: number
    study_plan_total_mandatory_credit: number
    study_plan_is_approved: boolean
    total_study_plan: number
    status_semester_id: string
    status_semester_school_year: string
    status_semester_type: string
    status_date: string
    ...
    gpa: number
    total_credit: number
    transacript_is_archived: boolean
    has_paid: boolean
    graduation_predicate: string
    study_duration_month: number
    thesis_duration_month: number
    thesis_duration_semester: number
}