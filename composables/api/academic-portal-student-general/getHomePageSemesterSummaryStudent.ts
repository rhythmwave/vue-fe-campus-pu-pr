...
import { GetHomePageSemesterSummaryRoot } from "~~/types/api/academic-portal-student-general/GetHomePageSemesterSummary";

export async function getHomePageSemesterSummaryStudent()
