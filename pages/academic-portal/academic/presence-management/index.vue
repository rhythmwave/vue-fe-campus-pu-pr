...
<template>
  ...
  <v-col cols="12">
    <v-alert type="info" variant="tonal">
      Keterangan : 
      <br />
      Pengelolaan Presensi dapat digunakan untuk memasukkan presensi mahasiswa secara on-line. Dosen dapat memberikan presensi sesuai dengan Mata Kuliah yang diampunya. Untuk memasukkan presensi Mata Kuliah yang ditawarkan oleh program studi lain dapat dilakukan dengan memilih Sistem Informasi Akademik yang bersesuaian.
    </v-alert>
  </v-col>
  <v-row>
    <v-col cols="12">
        ...
        <td>
          <v-tooltip text="Detil">
              <template #activator="{ props }">
                <NuxtLink class="text-decoration-none color-inherits" :to="'/academic-portal/academic/presence-management/'+item.id">
