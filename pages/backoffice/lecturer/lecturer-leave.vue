...
const title = ref('Data Cuti Dosen')
        ...
        <SharedUiParentCard :title="title">
            <v-row>
                ...
                <v-col cols="12" lg="4" md="6">
                    ...
                    <v-select item-value="id" variant="outlined" hide-details :items="SemesterLists" label="Semester"
                        @update:model-value="(c: any) => semesterOnchanged(c)">
            ...
            <v-row>
                <VCol cols="12" lg="12" md="12" class="text-right">
                    ...
                    <a target="_blank"
                        :href="'/backoffice/lecturer/prints/lecturer-leave/' + selectedAdminStudyProgramLists.id + '/' + selectedSemesterLists.id">
                        <v-btn color="success float-right" flat class="ml-2 mb-2"
                            :disabled="selectedAdminStudyProgramLists.id == '' || selectedSemesterLists.id == ''">
                            <PrinterIcon />Cetak Cuti Dosen
                        </v-btn>
                    </a>
                </VCol>
            </v-row>
