...
onMounted(async () => {
    ...
    await getLecturerLeaveListData(10000000, 1)
    await delay(1000)
    window.print()
})
...
async function getLecturerLeaveListData(limit: number, page: number) {
    try {
        const { response: resp, error: error } = await getLecturerLeaveList(limit, page, "", "", "", semester_id.value, true)
        if (error) {
...
<template>
    <div class="page-portrait">
        <div class="nobreak">
            ...
            <h2 align="center">DAFTAR CUTI DOSEN</h2>
            ...
            <table class="tabel-common" width="100%">
                <tbody>
                    ...
                    <tr v-for="ll, index in GetLecturerLeaveLists">
