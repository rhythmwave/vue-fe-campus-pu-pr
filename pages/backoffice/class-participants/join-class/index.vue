...
async function process(){
    ...
    router.push({path: '/backoffice/class-participants/join-class/classes', query: {class_id: classIds.value}})
}
        ...
        <v-table class="mt-10">
            ...
            <tfoot>
                <tr>
                    ...
                    <VBtn color="primary" flat class="ml-auto" @click="process" :disabled="classIds.length == 0">
                        <v-icon class="mr-2">
