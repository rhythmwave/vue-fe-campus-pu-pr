        ...
        <SharedUiParentCard :title="'Daftar '+title">
            <v-row>
                <v-col cols="12" lg="12" md="12">
                    ...
                    <v-col cols="12" lg="4" md="4" class="float-left">
                        <v-autocomplete v-model="subjectId" :items="subjects" item-title="name" item-value="id" density="compact" :label="'Pilih Mata Kuliah'" hide-details variant="outlined" />
                    </v-col>
                </v-col>
            </v-row>
        </SharedUiParentCard>
                        ...
                        <div class="d-flex align-center">
                            <v-tooltip text="Detail">
                                <template #activator="{ props }">
                                    <v-btn icon flat v-bind="props" :to="'/backoffice/class-participants/attendance/view/' + item.id">
                                        <EyeIcon stroke-width="1.5" size="20" class="text-primary" />
                                    </v-btn>
                                </template>
                            </v-tooltip>
                            <v-tooltip text="Rencana Dosen">
                                <template #activator="{ props }">
                                    <v-btn icon flat v-bind="props" :to="'/backoffice/class-participants/attendance/lecture-plan/' + item.id">
                            ...
                            <v-tooltip text="Presensi">
                                <template #activator="{ props }">
                                    <v-btn icon flat v-bind="props" :to="'/backoffice/class-participants/attendance/presence/' + item.id">
                                        <PencilIcon stroke-width="1.5" size="20" class="text-success" />
                                    </v-btn>
                                </template>
                            </v-tooltip>
                        </div>
