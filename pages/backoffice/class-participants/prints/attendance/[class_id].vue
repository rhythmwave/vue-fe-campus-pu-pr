                ...
                <table width="100%" class="tabel-common">
                    <tbody>
                        <tr>
                            ...
                            <th colspan="8">Tatap Muka Ke / Tanggal</th>
                        </tr>
                        <tr>
                            <th width="8%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th width="8%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                        ...
                        <tr>
                            <th colspan="11">MAHASISWA</th>
                        </tr>

                        <tr v-for="scp, i in pscp">
                            <td nowrap="nowrap" height="34">{{ i + 1 + ((page) * pageLimit) }}</td>
                            <td nowrap="nowrap">{{ scp.student_nim_number }}</td>
                            <td>
                                <div class="nama">{{ scp.student_name }}</div>
                            </td>
                            <td nowrap="nowrap">&nbsp;</td>
                            <td nowrap="nowrap">&nbsp;</td>
                            <td nowrap="nowrap">&nbsp;</td>
                        ...
                        <tr v-if="page + 1 == pageStudentClassParticipants.length">
                            <th colspan="11">DOSEN PENGAJAR</th>
                        </tr>

                        <tr v-if="page + 1 == pageStudentClassParticipants.length && classroomDetails.lecturers"
                            v-for="l, i in classroomDetails.lecturers">
                            <td nowrap="nowrap" height="34">{{ i + 1 }}</td>
                            <td nowrap="nowrap"></td>
                            <td>
                                <div class="nama">{{ l.front_title }} {{ l.name }} {{ l.back_degree }}</div>
                            </td>
                            <td nowrap="nowrap">&nbsp;</td>
                            <td nowrap="nowrap">&nbsp;</td>
                            <td nowrap="nowrap">&nbsp;</td>
