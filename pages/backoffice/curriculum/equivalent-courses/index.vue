        ...
        <v-table class="mt-5">
            <thead>
                <tr>
                    ...
                    <th class="text-subtitle-1 font-weight-semibold" colspan="3">Mata Kuliah Setara</th>
                </tr>
                <tr>
                    <th class="text-subtitle-1 font-weight-semibold">Memiliki Kesetaraan</th>
                    <th class="text-subtitle-1 font-weight-semibold">Tidak Memiliki Kesetaraan</th>
            ...
            <tbody>
                <tr v-for=" item, index  in  CuriculumList " :key="item.id">
                    ...
                    <td>
                        <v-tooltip text="Detail">
                                <template #activator="{ props }">
                                    <v-btn icon flat v-bind="props" :to="'/backoffice/curriculum/equivalent-courses/' + item.id">
                    ...
                    <td class="text-subtitle-1">{{ item.total_subject_with_equivalency }}</td>
                    <td class="text-subtitle-1">{{ item.total_subject }}</td>
                    <td class="text-subtitle-1">{{ item.total_subject - item.total_subject_with_equivalency }}</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
