...
const page = ref({ title: 'Kelulusan' });
const title = ref('Kelulusan')
                ...
                <UiParentCard title="Pencarian Mahasiswa">
                    <v-row>
                        ...
                        <v-col cols="12" lg="4" md="6">
                            ...
                            <v-row>
                                <v-col cols="6">
                                    <v-select v-model="from" :items="getYearBatch()" hide-details variant="outlined" label="Dari"></v-select>
                                ...
                                <v-col cols="6">
                                    <v-select v-model="to" :items="getYearBatch()" hide-details variant="outlined" label="Sampai"></v-select>
        ...
        <v-table class="mt-5">
            <thead>
                <tr>
                    ...
                    <th class="text-subtitle-1 font-weight-semibold">Predikat Lulus</th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="item, index in students" :key="item.id">
                    ...
                    <td class="text-subtitle-1">{{ item.graduation_predicate }}</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
