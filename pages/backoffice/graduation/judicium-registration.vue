...
const page = ref({ title: 'Pendaftaran Yudisium' });
const title = ref('Pendaftaran Yudisium')
...
<template>
    <div>
        ...
        <div v-if="mode == 'create'">
            <v-col cols="12" lg="8" md="6" class="text-right">
                <v-dialog v-model="dialogCreate" max-width="800">
                    <PagesBackofficeYudiciumApply @reload="getData(limit, 1)" @close="closeCreate()" />
                </v-dialog>
            </v-col>
        </div>
                ...
                <v-dialog v-model="dialogDelete" max-width="800">
                    <v-card>
                        <v-card-title class="pa-4 bg-secondary">
                            <span class="title text-white">Hapus Pendaftaran Yudisium</span>
                        </v-card-title>
                        <v-card-text>
        ...
        <v-row>
            <v-col cols="12">
                <UiParentCard title="Pencarian Pendaftaran Yudisium">
                    <v-row>
