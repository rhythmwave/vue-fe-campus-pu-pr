...
async function getData(limit: number, page: number) {
    try {
        const { response: resp, error: error } = await getGraduationSessionList(limit, page, "")
        if (error) {
...
<template>
    <div class="page-portrait">
        <div class="nobreak">
            ...
            <h2 align="center">Daftar Sesi Wisuda</h2>
            ...
            <table class="tabel-common" width="100%">
                <tbody>
                    ...
                    <tr v-for="ys, index in graduationSessions">
                        <td align="center">{{ index + 1 }}</td>
                        <td align="center">{{ ys.session_school_year }}</td>
                        <td align="center">{{ ys.session_number }}</td>
                        <td align="center">{{ moment (new Date(ys.session_date)).format("DD MM YYYY") }}</td>
                    </tr>
