...
async function getData(limit: number, page: number) {
    try {
        const { response: resp, error: error } = await getYudiciumSessionList(limit, page, "")
        if (error) {
...
<template>
    <div class="page-portrait">
        <div class="nobreak">
            ...
            <h2 align="center">Daftar Sesi Yudisium</h2>
            ...
            <table class="tabel-common" width="100%">
                <tbody>
                    ...
                    <tr v-for="ys, index in yudiciumSessions">
                        <td align="center">{{ index + 1 }}</td>
                        <td align="center">{{ ys.semester_school_year }}</td>
                        <td align="center">{{ ys.name }}</td>
