...
const page = ref({ title: 'Daftar Agenda Kelas' });
const title = ref('Daftar Agenda Kelas')
...
<template>
    <div>
        <div v-if="mode == 'show'">
            <v-col cols="12" lg="8" md="6" class="text-right">
                <v-dialog v-model="dialogShow" max-width="800">
                    <PagesBackofficeAdminClassAgendaDetail :classroom="detailData"
                        :studyProgram="selectedAdminStudyPrograms" :semester="selectedSemesters" />
                </v-dialog>
            </v-col>
        </div>
        ...
        <v-row>
            <v-col cols="12">
                <UiParentCard title="Pencarian Agenda Kelas">
                    <v-row>
                        ...
                        <v-col cols="12" lg="4" md="6">
                            ...
                            <v-select item-value="id" variant="outlined" hide-details :items="Semesters"
                                label="Semester" @update:model-value="(sl: any) => SemestersOnChange(sl)">
        ...
        <v-table class="mt-5">
            <thead>
                <tr>
                    ...
                    <th class="text-subtitle-1 font-weight-semibold">Jumlah Agenda</th>
