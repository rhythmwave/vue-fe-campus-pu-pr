...
const page = ref({ title: 'Daftar Materi Kuliah' });
const title = ref('Daftar Materi Kuliah')
...
<template>
    <div>
        <div v-if="mode == 'show'">
            <v-col cols="12" lg="8" md="6" class="text-right">
                <v-dialog v-model="dialogShow" max-width="800">
                    <PagesBackofficeAdminClassMaterialDetail :classroom="detailData"
        ...
        <v-row>
            <v-col cols="12">
                <UiParentCard title="Pencarian Materi Kuliah">
                    <v-row>
        ...
        <v-table class="mt-5">
            <thead>
                <tr>
                    ...
                    <th class="text-subtitle-1 font-weight-semibold">Jumlah Materi</th>
