...
const page = ref({ title: 'Daftar Diskusi Online' });
const title = ref('Daftar Diskusi Online')
...
<template>
    <div>
        <div v-if="mode == 'show'">
            <v-col cols="12" lg="8" md="6" class="text-right">
                <v-dialog v-model="dialogShow" max-width="800">
                    <PagesBackofficeAdminClassDiscussionDetail :classroom="detailData"
        ...
        <v-row>
            <v-col cols="12">
                <UiParentCard title="Pencarian Diskusi Online">
                    <v-row>
        ...
        <v-table class="mt-5">
            <thead>
                <tr>
                    ...
                    <th class="text-subtitle-1 font-weight-semibold">Jumlah Topik</th>
