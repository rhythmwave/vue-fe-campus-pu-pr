...
const page = ref({ title: 'Daftar Tugas Kelas' });
const title = ref('Daftar Tugas Kelas')
...
<template>
    <div>
        <div v-if="mode == 'show'">
            <v-col cols="12" lg="8" md="6" class="text-right">
                <v-dialog v-model="dialogShow" max-width="800">
                    <PagesBackofficeAdminClassWorkDetail :classroom="detailData" :studyProgram="selectedAdminStudyPrograms"
        ...
        <v-row>
            <v-col cols="12">
                <UiParentCard title="Pencarian Tugas Kelas">
                    <v-row>
        ...
        <v-table class="mt-5">
            <thead>
                <tr>
                    ...
                    <th class="text-subtitle-1 font-weight-semibold">Jumlah Tugas</th>
