...
watch(studyProgramId, async function(value){
    if(value != ''){
        await getStudent(pagination.value.limit, 1)
    }
})
            ...
            <v-col cols="12">
                <UiParentCard :title="title">
                    <v-row>
                        ...
                        <v-col cols="12" lg="4" md="6">
                            <v-text-field v-model="search" variant="outlined" hide-details label="Cari"></v-text-field>
                        </v-col>
                    </v-row>
                </UiParentCard>
            </v-col>
        ...
        <v-table class="mt-5">
            ...
            <tbody>
                <tr v-for="(item, index) in students">
                    ...
                    <td>1</td>
                    <td>
                        <nuxt-link :to="'/backoffice/implementation-of-mbkm/convert-value-mbkm/'+ item.id">
