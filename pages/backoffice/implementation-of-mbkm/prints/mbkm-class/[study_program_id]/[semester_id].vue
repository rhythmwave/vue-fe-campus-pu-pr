...
async function getClassroom(limit: number, page: number) {
    try {
        const { response: resp, error: error } = await getClassroomList(limit, page, "", study_program_id.value, semester_id.value, true, '', true)
        if (error) {
...
<template>
    <div class="page-portrait">
        <div class="nobreak">
            ...
            <h2 align="center">DAFTAR KELAS MBKM</h2>
            ...
            <table class="tabel-common" width="100%">
                <tbody>
                    <tr>
                        ...
                        <th width="80" rowspan="2">Nama Kelas</th>
                        <th width="40" rowspan="2">Sifat</th>
                        <th colspan="4">Jumlah SKS</th>
                    </tr>
                    <tr>
                        <th width="60">Kode</th>
                        <th width="200">Nama</th>
                        <th width="40"><strong>T</strong></th>
                        <th width="40"><strong>P</strong></th>
                        <th width="40"><strong>PL</strong></th>
                        <th width="50"><strong>Total</strong></th>
                    </tr>

                    <tr v-for="ll, index in classrooms">
                        <td align="center">{{ index + 1 }}</td>
                        <td align="center">{{ ll.subject_code }}</td>
                        <td align="center">{{ ll.subject_name }}</td>
                        <td align="center">{{ ll.name }}</td>
                        <td align="center">{{ ll.subject_is_mandatory ? 'W' : 'P' }}</td>
                        <td align="center">{{ ll.subject_theory_credit }}</td>
                        <td align="center">{{ ll.subject_practicum_credit }}</td>
                        <td align="center">{{ ll.subject_field_practicum_credit }}</td>
                        <td align="center">{{ ll.subject_theory_credit
                            + ll.subject_practicum_credit + ll.subject_field_practicum_credit }}</td>
