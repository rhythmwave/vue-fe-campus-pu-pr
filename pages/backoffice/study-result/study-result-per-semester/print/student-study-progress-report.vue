    ...
    <div>
        <table class="table" v-for="(itm, indx) in detail_students">
            <thead>
                ...
                <tr>
                    ...
                    <th class="text-left">
                        <div style="width: 50%; float: right;">
                            <p><b>Yth. Bapak/Ibu/Saudara</b></p>
                            <p><b>{{ itm.father_death_date == '' ? itm.father_name : itm.mother_death_date == '' ? itm.mother_name : itm.guardian_death_date == '' ? itm.guardian_name : itm.name }}</b></p>
                            <p><b>Di</b></p>
                            <p><b>Tempat</b></p>
                        </div>
                    </th>
                ...
                <tr>
                    <th colspan="7">
                        <p><b>LAPORAN KEMAJUAN STUDI MAHASISWA</b></p>
                    </th>
                </tr>
                <tr>
                    <th colspan="2" class="text-left">
                        ...
                        <p>Pembimbing Skripsi (I)</p>
                        <p>Pembimbing Skripsi (II)</p>
                        <p>Semester</p>
                    </th>
                    <th colspan="2" class="text-left">
                        <p>: {{ itm.name }}</p>
                ...
                <tr style="text-align: left;">
                    ...
                    <th class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">Kode Matakuliah</th>
                    <th class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">Nama Matakuliah</th>
                    <th class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">SKS</th>
                    <th class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">KE</th>
                    <th class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">Nilai</th>
                    <th class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">Nilai SKS</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ resultSummaryTotalCredit }}</td>
                    <td>0</td>
                    <td>0.00</td>
                    <td>0.00</td>
                </tr>
                ...
                <tr style="border: 1px solid;">
                    ...
                    <td colspan="2" style="border: 1px solid;"><b>Telah Ditempuh</b></td>
                    <td colspan="3" style="border: 1px solid;"><b>Ketentuan Lulus</b></td>
                </tr>
                <tr style="border: 1px solid;">
                    <td colspan="2" style="border: 1px solid;">1. Jumlah sks</td>
                    <td colspan="2" style="border: 1px solid;"><b>0</b></td>
                    <td colspan="3" style="border: 1px solid;"><b>0</b></td>
                </tr>
                <tr style="border: 1px solid;">
                    <td colspan="2" style="border: 1px solid;">2. Indeks Prestasi Semester</td>
                    <td colspan="2" style="border: 1px solid;"><b>0</b></td>
                    <td colspan="3" style="border: 1px solid;"><b>0</b></td>
                </tr>
                <tr style="border: 1px solid;">
                    <td colspan="2" style="border: 1px solid;">3. Indeks Prestasi Kumulatif</td>
                    <td colspan="2" style="border: 1px solid;"><b>0</b></td>
                    <td colspan="3" style="border: 1px solid;"><b>0</b></td>
                </tr>
                <tr style="border: 1px solid;">
                    <td colspan="2" style="border: 1px solid;">4. Maksimal sks nilai D</td>
                    <td colspan="2" style="border: 1px solid;"><b>0</b></td>
                    <td colspan="3" style="border: 1px solid;"><b>0</b></td>
                </tr>
                <tr style="border: 1px solid;">
                    <td colspan="2" style="border: 1px solid;">5. Masa studi aktif</td>
                    <td colspan="2" style="border: 1px solid;"><b>0</b></td>
                    <td colspan="3" style="border: 1px solid;"><b>0</b></td>
                </tr>
            </tbody>
