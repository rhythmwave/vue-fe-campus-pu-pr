    ...
    <div>
        <table class="table" v-for="(itm, indx) in detail_students">
            <thead>
                ...
                <tr>
                    <th colspan="6">
                        <p><b>LAPORAN HASIL STUDI MAHASISWA (LHS)</b></p>
                    </th>
                </tr>
                <tr>
                ...
                <tr style="text-align: left;">
                    ...
                    <th colspan="2" class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">Nama Matakuliah</th>
            ...
            <tbody>
                <tr v-for="item, index in resultStudentClasses[itm.id]">
                    ...
                    <td colspan="2">{{ item.subject_name }}</td>
