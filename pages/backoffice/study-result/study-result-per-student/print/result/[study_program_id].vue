            ...
            <thead>
                ...
                <tr style="text-align: left;">
                    ...
                    <th rowspan="2" class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">
                        Kredit</th>
                    <th colspan="2" class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">
                        Nilai</th>
                    <th rowspan="2" class="font-size-10 head-title" style="text-align: center; vertical-align: middle;">K X
                        N</th>
                </tr>
                <tr style="text-align: left;">
                    <th class="font-size-10 head-title">Kode</th>
                    <th colspan="3" class="font-size-10 head-title">Nama</th>
                    <th class="font-size-10 head-title">Huruf</th>
                    <th class="font-size-10 head-title">Angka</th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="item, index in itm.data">
                    ...
                    <td colspan="3">{{ item.subject_name }}</td>
                ...
                <tr>
                    <td class="text-left" colspan="6" rowspan="2">
                        <p>
                            <b>
                                Keterangan : <br> KHS ini Syah dan Benar, Bila tanpa ada Coretan dan Tip-Ex
                            </b>
                        </p>
                    </td>
                ...
                <tr>
                    <td colspan="2">Beban SKS Berikut</td>
                    <td>0</td>
                </tr>
            </tbody>
            <tfoot v-if="(indx + 1) == arr_student_classes[it].length">
                <tr>
                    <td colspan="7"></td>
                    <td colspan="2" class="text-right">
                        <div class="text-center" style="margin: 0px 50px 0px 0px;">
                            <p>{{ new Date().getDate() }}, {{ convertMonthToTextString(new Date().getMonth() + 1) }} {{ new
                                Date().getFullYear() }}</p>
                            <p>..................................................</p>
                            <p style="margin-top: 100px; border-bottom:1px solid">
                                ..................................................</p>
                            <p>NIDN: ........................................</p>
                        </div>
                    </td>
