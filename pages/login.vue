...
definePageMeta(<PageMeta>{
  layout: "blank",
  middleware: ['check-auth-loginpage'],
});
// console.log(vue-recaptcha-v3)
  ...
  <div class="pa-3">
    <v-row class="h-100vh mh-100 auth">
      <v-col cols="12" lg="7" xl="8" class="d-lg-flex align-center justify-center authentication position-relative">
        ...
        <div class="">
          <img src="/images/backgrounds/login-bg.svg" class="position-relative d-none d-lg-flex" alt="login-background">
        </div>
      </v-col>
      <v-col cols="12" lg="5" xl="4" class="d-flex align-center justify-center">
        <div class="mt-xl-0 mt-5 mw-100">
          ...
          <div class="text-subtitle-1 mb-6">
            Smart Campus Politeknik Pekerjaan Umum
          </div>
          <AuthLoginFormSmartCampuss :get_sso_auth="getSSoAuths" />
          <!-- <AuthLoginForm /> -->
